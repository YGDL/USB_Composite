...
#define  USBD_IDX_CDC_CONTROL_INTERFACE_STR				0x05U
#define  USBD_IDX_CDC_DATA_INTERFACE_STR				0x06U
#define  USBD_IDX_MSC_DATA_INTERFACE_STR				0x07U
#define  USBD_IDX_HID_DATA_INTERFACE_STR				0x08U
#define  USBD_IDX_CDC_IAD_STR							0x09U
#define  USBD_IDX_MSC_IAD_STR							0x0AU
#define  USBD_IDX_HID_IAD_STR							0x0BU
...
typedef struct
{
	...
	uint8_t *(*GetCDCControlInterfaceStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
	uint8_t *(*GetCDCDataInterfaceStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
	uint8_t *(*GetMSCDataInterfaceStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
	uint8_t *(*GetHIDDataInterfaceStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
	uint8_t *(*GetCDCIADStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
	uint8_t *(*GetMSCIADStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
	uint8_t *(*GetHIDIADStrDescriptor)(USBD_SpeedTypeDef speed, uint16_t *length);
